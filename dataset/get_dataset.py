...
def main(path_input, path_output, window_size,data_type,label_path):#,split_dataset
    result=[]
    label=[]
...
if __name__ == "__main__":
    ...
    main(path_input, path_output, window_size,data_type,label_path)#,split_dataset
